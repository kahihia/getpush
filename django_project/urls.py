...
urlpatterns = patterns('',
  ...
  url(r'^dashboard/segmentation/delete/(?P<id>.+)$', 'segments.views.delete', name='segments_delete'),
                       ...
                       # unsubscribe
  url(r'^unsubscribe/(?P<client_profile_id>.+)$', 'unsubscribe.views.unsubscribe', name='unsubscribe'),
                       # TODO: handle unregister
  #affiliates
  url(r'^af/', include('affiliates.urls')),
                       # Examples:
  url(r'^$', 'django_project.views.home', name='home'),
                       url(r'^agent-schedule$', 'django_project.views.save', name='save'),
                       url(r'^agent-schedule/(?P<id>\d+)$', 'django_project.views.schedule', name='schedule'),
                       url(r'^agent-start/', TemplateView.as_view(template_name='banner.html'), name='banner'),
                       url(r'^start/', TemplateView.as_view(template_name='agent.html'), name='agent'),
                       url(r'^schedule/', TemplateView.as_view(template_name='agent-schdule.html'), name='agent-schdule'),
                       url(r'^time/(?P<id>\d+)$', 'django_project.views.schedulesave', name='schedulesave'),
